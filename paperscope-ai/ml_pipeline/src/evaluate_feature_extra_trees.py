...
MODEL_DIR = BASE_DIR / "outputs" / "models" / "feature_extra_trees_v1"
...
EVAL_TXT_PATH = REPORT_DIR / "feature_extra_trees_evaluation.txt"
CONF_MATRIX_PATH = REPORT_DIR / "feature_extra_trees_confusion_matrix.csv"
EVAL_JSON_PATH = REPORT_DIR / "feature_extra_trees_evaluation_summary.json"
...
def main():
    ...
    summary = {
        "model_name": "feature_extra_trees_v1",
