...
OUT_DIR = BASE_DIR / "outputs" / "models" / "feature_extra_trees_v1"
...
def main():
    ...
    # Selection metric: validation macro-F1 first, then accuracy.
    candidate_configs = [
    ...
    # Validation metrics from the selected train-only model
