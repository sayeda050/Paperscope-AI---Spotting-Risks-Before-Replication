...
MODEL_DIR = BASE_DIR / "outputs" / "models" / "feature_hist_gradient_boosting_rich_v1"
...
EVAL_TXT_PATH = REPORT_DIR / "feature_hist_gradient_boosting_rich_evaluation.txt"
CONF_MATRIX_PATH = REPORT_DIR / "feature_hist_gradient_boosting_rich_confusion_matrix.csv"
EVAL_JSON_PATH = REPORT_DIR / "feature_hist_gradient_boosting_rich_evaluation_summary.json"
